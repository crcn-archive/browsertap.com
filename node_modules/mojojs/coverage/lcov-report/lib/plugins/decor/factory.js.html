...
<html lang="en">
<head>
    <title>Code coverage report for lib/plugins/decor/factory.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/plugins/decor/factory.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/plugins/decor/</a> &#187; factory.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (!proto.__decorators || <span class="branch-1 cbranch-no" title="branch not covered" >proto.__decorOwner != proto)</span> {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (used[i] &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >d.multi === false)</span> <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
