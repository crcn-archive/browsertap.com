...
<html lang="en">
<head>
    <title>Code coverage report for lib/bindable/inheritable.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/bindable/inheritable.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">98.81% <small>(83 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/bindable/</a> &#187; inheritable.js</div>
</div>
<div class="body">
...
&nbsp;
      ...
      valueBinding = this.bind(key).to(function(value) {
        var _ref;
&nbsp;
        if (((_ref = _this.parent) != null ? _ref[key] : <span class="branch-1 cbranch-no" title="branch not covered" >void 0)</span> === value) {
          return;
        }
        valueBinding.dispose();
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (parentPropertyBinding != null) {
          parentPropertyBinding.dispose();
        }
        return parentBinding != null ? parentBinding.dispose() : <span class="branch-1 cbranch-no" title="branch not covered" >void 0;</span>
      });
      valueBinding.now();
      <span class="missing-if-branch" title="if path not taken"" >I</span>if ((this[key] == null) &amp;&amp; typeof process === "undefined") {
<span class="cstat-no" title="statement not covered" >        console.warn("inherted property %s doesn't exist in %s", key, this.path());</span>
      }
      return void 0;
    };
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Dec 05 2013 19:34:47 GMT-0800 (PST)</div>
</div>
